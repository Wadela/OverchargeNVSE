...
public:
	...
	virtual void GetGrassForLocation(NiPoint2, NiPoint2, TESGrassAreaParam*, UInt32);
	...
	struct OFFSET_DATA {
		...
		NiPoint2	kMin;		// 004 NAM0
		NiPoint2	kMax;		// 00C NAM9
		UInt32		uiFileOffset;	// 014 TESWorldSpace file offset in modInfo
	};
	...
	bool FindCellInFile(TESFile* apFile, SInt32 x, SInt32 y);
	TESObjectCELL* GetCellFromKey(SInt32 aiKey);
	TESObjectCELL* LoadCell(SInt32 x, SInt32 y);
