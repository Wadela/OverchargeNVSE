...
namespace Overcharge
{
    ...
    void InitWeaponData()
    {
        ...
        weaponDataMap =
        {
            ...
            {plasmaRifleID, HeatData(HeatInfo(0.0f, 40.0f, 20.0f, 300.0f), HeatFX(NiColor(0.655f, 1.000f, 0.486f), NiColor(0.655f, 0.486f, 1.000f), {"##PLRPlane1:0", "##PLRCylinder1:0", "##PLRCylinder2:0", "##PLRCylinder3:0"}))}
        };
    }
}